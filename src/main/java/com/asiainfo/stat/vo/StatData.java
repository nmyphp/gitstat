...
public class StatData
    ...
    public StatData addData(StatData sd) {
        ...
        return new StatData(this.name, this.add + sd.add, this.del + sd.del, this.file + sd.file, this.first, sd.last,
            this.adds, this.dels);
    }
    ...
    public String toString() {
        return "name:" + this.name + "; add:" + this.add + "; del:" + this.del + "; files:" + this.file + "; first:"
            + this.first + "; last:" + this.last;
    }
